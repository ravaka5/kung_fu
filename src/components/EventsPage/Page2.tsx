import event1 from "../../assets/img/EventsBg.jpeg"
import { MdOutlineKeyboardArrowDown } from 'react-icons/md';
const Page2 = () => {
  return (
    <div className='w-screen h-screen flex justify-center items-center' >
        <div className='h-100 w-screen bg-center bg-cover bg-fixed flex justify-center items-center' style={{ backgroundImage: `url(${event1})` }}>
