import piscine from "../../assets/img/eventspg/piscine.png"
import ball from "../../assets/img/eventspg/ball.png"
import gaming from "../../assets/img/eventspg/gaming.png"
    ...
    <section className='w-screen h-screen flex justify-center items-center'>
        <div className="flex flex-col gap-[1vw] text-red-700">
            ...
            <div className="flex gap-[2vw] text-white font-bold text-center font-poppins">
                <div className="w-[24vw] px-[2vw] py-[1vw] h-[30vw] flex items-end justify-center rounded-[1.4vw]" style={{ backgroundImage: `url(${ball})` }}>
                    <p className="text-[1.1vw]">AMUSEZ VOUS AVEC VOS AMIS SUR NOTRE TERRAIN DE BASKETBALL</p>
                </div>
                <div className="w-[24vw] px-[2vw] py-[1vw] h-[30vw] flex items-end justify-center rounded-[1.4vw]" style={{ backgroundImage: `url(${piscine})` }}>
                    <p className="text-[1.1vw]">RELAXEZ VOUS DANS L’EAU DE NOTRE PISCINE</p>
                </div>
                <div className="w-[24vw] px-[2vw] py-[1vw] h-[30vw] flex items-end justify-center rounded-[1.4vw]" style={{ backgroundImage: `url(${gaming})` }}>
